package com.reportsapi.service.impl;
...
import com.reportsapi.service.ReportService;
...
public class ReportServiceImpl implements ReportService {
	...
	public void generatePdf(HttpServletResponse response) throws Exception {
		...
		cell.setPhrase(new Paragraph("Mobile", font));
		table.addCell(cell);

		cell.setPhrase(new Paragraph("Gender", font));
		table.addCell(cell);

		cell.setPhrase(new Paragraph("SSN", font));
		table.addCell(cell);
